...
class AccountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userControllrer) {
        return _userLoggedIn
            ? (userControllrer.isloading
                ? Container(
                            ...
                            child: Column(
                              children: [
                                AccountWidget(
                                  ...
                                  bigText: BigText(
                                      text: userControllrer.userModel.name),
                                ),
                                SizedBox(
                                ...
                                AccountWidget(
                                  ...
                                  bigText: BigText(
                                      text: userControllrer.userModel.phone),
                                ),
                                SizedBox(
                                  height: Dimensions.height20,
                                ),
                                ...
                                AccountWidget(
                                  ...
                                  bigText: BigText(
                                      text: userControllrer.userModel.email),
                                ),
                                SizedBox(
                                  height: Dimensions.height20,
                                ),
